...
/// Implements some of the more often used non-parametric tests.
/// Non-parametric tests are constructed to analyze data that do not follow a speiciic ditrisbution.
