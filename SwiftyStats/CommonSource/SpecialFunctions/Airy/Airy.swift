...
extension SSSpecialFunctions {
    ...
    ///
    /// -- FABIJONAS, LOZIER, OLVER: Computation of Complex Airy Functions and Their Zeros Using Asymptotics and the Differential Equation. ACM Transactions on Mathematical Software, Vol. 30, No. 4, December 2004, Pages 471–490
    /// - Remark:
    /// Errors (Double)
    ///
    /// for Ai: -200 <= x <= 200, step 0.5
    ///
