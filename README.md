...
* fewer typos
* parameters for Poisson and Binomial distributions
* refactoring
...
* [`SSCrossTab`](docs/Structures/SSCrossTab.html) contains a cross table with the usual structure (like an n x m matrix) and provides the statistics needed for frequency comparisons (Chi-square, Phi, residuals etc.).
...
#### Probability Functions (cdf, pdf, quantile, parameters - see above)
